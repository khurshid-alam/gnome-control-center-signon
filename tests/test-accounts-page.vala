...
int main (string[] args)
{
    ...
    Test.add_func ("/credentials/accountspage/create", accountspage_create);
    */
...
void accountspage_create ()
{
    /* Prevent warnings from making the test fail. */
    Test.log_set_fatal_handler (log_is_fatal);

    var page = Gtk.test_create_widget (typeof (Cc.Credentials.AccountsPage));
}
